...
const navigation = [
  {
    ...
    links: [
      ...
      {
        name: "Roadmap",
        href: "https://github.com/orgs/klyra-hq/projects/4/views/2",
      },
    ],
  },
  {
    ...
    links: [
      ...
      {
        name: "Careers",
        href: "https://www.workatastartup.com/companies/klyra",
      },
    ],
  },
  {
    ...
    links: [
      ...
      {
        name: "Guides",
        href: "https://github.com/klyra-hq/klyra/tree/main/examples",
      },
      {
        name: "Contributors",
        href: "https://github.com/klyra-hq/klyra/graphs/contributors",
      },
    ],
  },
  {
    ...
    links: [
      ...
      {
        name: "Linkedin",
        href: "https://www.linkedin.com/company/klyra-yc/",
      },
    ],
  },
];
    ...
    <>
      ...
      <footer className="mx-auto max-w-6xl py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 flex flex-col gap-2 sm:flex-row">
          <p className="text-base dark:text-gray-300">&copy; 2022 klyra</p>
