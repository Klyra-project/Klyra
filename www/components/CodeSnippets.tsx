      ...
      <div className="grid w-full grid-cols-1 gap-4 lg:grid-cols-12">
        <div className="mb-4 lg:col-span-5">
          ...
          <p className="mt-3 text-lg text-slate-500 dark:text-gray-300 sm:mt-4">
            Klyra is built for Rust.
          </p>

          <p className="mt-3 text-lg text-slate-500 dark:text-gray-300 sm:mt-4">
            A simple cargo command packages up your application, ships it to the
            klyra build cluster where it's incrementally compiled and
            automatically served on a unique subdomain.
          </p>

          <p className="mt-3 text-lg text-slate-500 dark:text-gray-300 sm:mt-4">
            Klyra uses simple but powerful annotations to understand your
...
const CARGO_DEPLOYS = `
$ cargo klyra deploy
   Packaging url-shortener v0.1.0 (/private/klyra/examples/url-shortener)
   Archiving Cargo.toml
   Archiving Cargo.toml.orig
   Archiving README.md
   Archiving Klyra.toml
   ...
   Compiling klyra-service v0.2.5
   Compiling url-shortener v0.1.0 (/opt/unveil/crates/s-2)
    Finished dev [unoptimized + debuginfo] target(s) in 1m 01s
        ...
        Host:               url-shortener.klyraapp.rs
        Created At:         2022-04-01 08:32:34.412602556 UTC
        Database URI:       postgres://***:***@pg.klyra.rs/db-url-shortener
