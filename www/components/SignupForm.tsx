...
const links = [
  { name: "💻 contributing to klyra", href: CONTRIBUTING_URL },
    ...
    return (
      <div className="mb-4 lg:col-span-5">
        ...
        <p className="text-lg text-slate-500 dark:text-gray-300">
          If you are looking for a way to support klyra in the meantime, you
          can do so by:
        </p>
      ...
      <div className="mt-5">
        ...
        <div className="mt-4 px-10 text-xl text-slate-500 dark:text-gray-300">
          Sign up to our closed beta and get updated on the{" "}
          {
            <ExternalLink
              key="klyra-next"
              href="https://klyra.rs/blog/2022/10/21/klyra-beta"
              className="text-brand-orange1 hover:text-brand-orange2"
            >
              next iteration of klyra
            </ExternalLink>
          }
