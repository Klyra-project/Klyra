...
<TLDR>
    ...
    <p>We're announcing [klyra-next](https://klyra.rs/beta): a next-generation backend development framework that has up to **100x smaller images** and **deploys end-to-end in under a second**.</p>
</TLDR>
...
Since then, more than 1k people starred the [klyra repo](https://github.com/klyra-hq/klyra) and hundreds joined our discord community. klyra as a platform has now seen more 2000 deployments and hundreds of users. And we received a ton of feedback from it all.
