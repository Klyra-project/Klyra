...
On its way to settling in its standards, the cloud - epitomized by AWS - has evolved massively over the past decade. My co-founder has written a [post on this](https://www.klyra.rs/blog/2022/05/09/ifc) previously.
...
When we launched [klyra](https://klyra.rs/) for its early alpha, back in March 2022, our purpose was to address the issues people face when building and deploying web app backends. So we created an open-source infrastructure-from-code platform with which you don’t need to write Containerfiles and orchestrate images, starting with support for Rust.

Since then, more than 1.2k people starred the [klyra repo](https://github.com/klyra-hq/klyra) and hundreds joined our discord community. And we've seen more than 2000 deployments and hundreds of users! From which we received a ton of feedback.
...
We are launching klyra-next as part of our closed beta for klyra later this month, with the public release coming soon after. If you’re keen to give it a try early, **[sign up for the beta!](https://klyra.rs/beta)** We'd love to know what you think!

In the meantime, check out [klyra's GitHub repo](https://github.com/klyra-hq/klyra) and [Twitter](https://twitter.com/klyra_dev) for updates. If you’d like to support us, please star the repo and/or join the [klyra Discord community](https://discord.gg/klyra)!
