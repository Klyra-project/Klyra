...
`klyra` does a lot of this stuff for you - I just didn't remember how. I quickly head over to the [klyra / sqlx](https://docs.rs/klyra-service/0.2.5/klyra_service/#using-sqlx) section in the docs. I added the `sqlx` dependency to `Cargo.toml` and change *one line* in `lib.rs`:
