...
pub static X_klyra_CTL_SECRET: HeaderName = HeaderName::from_static("x-klyra-ctl-secret");

pub struct XKlyraCtlSecret(pub String);

impl Header for XKlyraCtlSecret {
    fn name() -> &'static HeaderName {
        &X_klyra_CTL_SECRET
    }
