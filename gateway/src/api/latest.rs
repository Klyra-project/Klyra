...
#[instrument(skip_all, fields(klyra.project.name = %project_name))]
#[utoipa::path(
    post,
    path = "/projects/{project_name}",
    responses(
...
#[instrument(skip_all, fields(klyra.project.name = %scoped_user.scope))]
#[utoipa::path(
    delete,
...
async fn route_project(
        ...
        && uri_path == format!("/projects/{}/services/{}", project_name, project_name)
    {
        ...
        tokio::spawn(async move {
            let event = async_posthog::Event::new("klyra_api_start_deployment", &account_name);
...
#[instrument(skip_all, fields(klyra.project.name = %project_name, %fqdn))]
#[utoipa::path(
    post,
...
#[openapi(
    ...
    components(schemas(
        ...
        klyra_common::models::admin::ProjectResponse,
        klyra_common::models::stats::LoadResponse,
