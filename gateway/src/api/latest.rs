...
use klyra_common::models::{project, stats};
use klyra_common::{request_span, VersionInfo};
...
use super::auth_layer::KlyraAuthLayer;

pub const SVC_DEGRADED_THRESHOLD: usize = 128;
pub const klyra_GATEWAY_VARIANT: &str = "klyra-gateway";
...
#[utoipa::path(
    ...
    responses(
        (status = 200, description = "Successfully got a specific project information.", body = klyra_common::models::project::Response),
...
#[utoipa::path(
    ...
    path = "/projects",
    responses(
        (status = 200, description = "Successfully got the projects list.", body = [klyra_common::models::project::Response]),
        (status = 500, description = "Server internal error.")
    ),
    params(
        PaginationDetails
...
#[utoipa::path(
    ...
    path = "/projects/{project_name}",
    responses(
        (status = 200, description = "Successfully created a specific project.", body = klyra_common::models::project::Response),
        (status = 500, description = "Server internal error.")
    ),
    params(
        ("project_name" = String, Path, description = "The name of the project."),
...
#[utoipa::path(
    ...
    path = "/projects/{project_name}",
    responses(
        (status = 200, description = "Successfully destroyed a specific project.", body = klyra_common::models::project::Response),
        (status = 500, description = "Server internal error.")
    ),
    params(
        ("project_name" = String, Path, description = "The name of the project."),
...
async fn destroy_project(
    ...
    if response.state == klyra_common::models::project::State::Destroyed {
    ...
    response.state = klyra_common::models::project::State::Destroying;
...
#[utoipa::path(
    ...
    responses(
        (status = 200, description = "Successfully deleted a project, unless dry run.", body = klyra_common::models::project::Response),
...
async fn delete_project(
    ...
    if res.status() != StatusCode::NOT_FOUND {
        ...
        let summary: klyra_common::models::service::Summary = serde_json::from_slice(&body_bytes)
            .map_err(|e| Error::source(ErrorKind::Internal, e))?;
    ...
    if res.status() != StatusCode::NOT_FOUND {
        ...
        let body_bytes = hyper::body::to_bytes(res.into_body())
            .await
            .map_err(|e| Error::source(ErrorKind::Internal, e))?;
        let resources: Vec<klyra_common::resource::Response> =
        ...
        let resources = resources
            ...
            .filter(|resource| {
                matches!(
                    resource.r#type,
                    klyra_common::resource::Type::Database(_)
                        | klyra_common::resource::Type::Secrets
                )
            })
...
async fn get_status(
    ...
    if sender.is_closed() || sender.capacity() == 0 {
        statuses.push((klyra_GATEWAY_VARIANT, StatusResponse::unhealthy()));
    } else if sender.capacity() < WORKER_QUEUE_SIZE - SVC_DEGRADED_THRESHOLD {
        statuses.push((klyra_GATEWAY_VARIANT, StatusResponse::degraded()));
    } else {
        statuses.push((klyra_GATEWAY_VARIANT, StatusResponse::healthy()));
    };
    ...
    statuses.push(("klyra-provisioner", provisioner_status));
    ...
    statuses.push(("klyra-auth", auth_status));
...
#[utoipa::path(
    ...
    path = "/stats/load",
    responses(
        (status = 200, description = "Successfully fetched the build queue load.", body = klyra_common::models::stats::LoadResponse),
        (status = 500, description = "Server internal error.")
    )
)]
async fn post_load(
...
#[utoipa::path(
    ...
    path = "/stats/load",
    responses(
        (status = 200, description = "Successfully removed the build with the ID specified in the load request from the build queue.", body = klyra_common::models::stats::LoadResponse),
        (status = 500, description = "Server internal error.")
    )
)]
...
#[utoipa::path(
    ...
    responses(
        (status = 200, description = "Successfully gets the build queue load as an admin.", body = klyra_common::models::stats::LoadResponse),
        (status = 500, description = "Server internal error.")
    )
)]
...
#[utoipa::path(
    ...
    path = "/admin/stats/load",
    responses(
        (status = 200, description = "Successfully clears the build queue.", body = klyra_common::models::stats::LoadResponse),
        (status = 500, description = "Server internal error.")
    )
)]
...
#[utoipa::path(
    ...
    path = "/admin/projects",
    responses(
        (status = 200, description = "Successfully fetched the projects list.", body = klyra_common::models::project::AdminResponse),
        (status = 500, description = "Server internal error.")
    )
)]
...
#[openapi(
    ...
    components(schemas(
        klyra_common::models::project::Response,
        klyra_common::models::stats::LoadResponse,
        klyra_common::models::project::AdminResponse,
        klyra_common::models::stats::LoadResponse,
        klyra_common::models::project::State
    ))
)]
pub struct ApiDoc;
...
impl ApiBuilder {
    ...
    pub fn with_default_routes(mut self) -> Self {
        ...
        const CARGO_klyra_VERSION: &str = env!("CARGO_PKG_VERSION");
            ...
            .route(
                ...
                get(|| async {
                    axum::Json(VersionInfo {
                        ...
                        cargo_klyra: env!("CARGO_PKG_VERSION").parse().unwrap(),
                        deployer: env!("CARGO_PKG_VERSION").parse().unwrap(),
                        runtime: CARGO_klyra_VERSION.parse().unwrap(),
                    })
                }),
            )
            .route(
                "/version/cargo-klyra",
                get(|| async { CARGO_klyra_VERSION }),
            )
            .route(
                "/projects",
