...
impl FromStr for ProjectName {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        s.parse::<klyra_common::project::ProjectName>()
...
impl From<ProjectDetails> for klyra_common::models::project::AdminResponse {
...
pub mod tests {
    ...
    use klyra_common::deployment::State;
    use klyra_common::log;
    use klyra_common::models::{deployment, project, service, user};
    use sqlx::SqlitePool;
    ...
    impl World {
        pub async fn new() -> Self {
            ...
            let image = env::var("klyra_TESTS_RUNTIME_IMAGE")
                .unwrap_or_else(|_| "public.ecr.aws/klyra/deployer:latest".to_string());
            ...
            let args = StartArgs {
                ...
                context: ContextArgs {
                    ...
                    provisioner_host,
                    network_name,
                    proxy_fqdn: FQDN::from_str("test.klyraapp.rs").unwrap(),
                },
            };
    ...
    async fn end_to_end() {
        ...
        proxy_client
            .request(
                Request::get("/hello")
                    .header("Host", "matrix.test.klyraapp.rs")
                    .header("x-klyra-project", "matrix")
                    .body(Body::empty())
                    .unwrap(),
            )
            .map_ok(|resp| {
