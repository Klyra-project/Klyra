...
impl From<ProjectDetails> for klyra_common::models::admin::ProjectResponse {
...
pub mod tests {
    ...
    use klyra_proto::test_utils::resource_recorder::get_mocked_resource_recorder;
    ...
    impl World {
        pub async fn new() -> Self {
            ...
            let image = env::var("klyra_TESTS_RUNTIME_IMAGE")
                .unwrap_or_else(|_| "public.ecr.aws/klyra-dev/deployer:latest".to_string());
    ...
    impl TestProject {
        ...
        /// Destroy / stop a project. Like `cargo klyra project stop`
