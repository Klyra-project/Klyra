...
pub struct StartArgs {
    ...
    #[arg(long, default_value = "https://console.klyra.rs")]
...
pub struct ServiceArgs {
    ...
    #[arg(long, default_value = "public.ecr.aws/klyra/deployer:latest")]
    pub image: String,
    /// Prefix to add to the name of all docker resources managed by
    /// this service
    #[arg(long, default_value = "klyra_prod_")]
    pub prefix: String,
    ...
    #[arg(long, default_value = "klyra_default")]
    pub network_name: String,
    /// FQDN where the proxy can be reached at
    #[arg(long, default_value = "klyraapp.rs")]
    pub proxy_fqdn: FQDN,
