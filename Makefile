...
.PHONY: images clean src up down deploy docker-compose.rendered.yml klyra-% postgres docker-compose.rendered.yml test

clean:
	rm .klyra-*
	rm docker-compose.rendered.yml

images: klyra-provisioner klyra-deployer postgres
