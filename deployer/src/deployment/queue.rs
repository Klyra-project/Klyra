...
use serde_json::json;
use klyra_common::backends::auth::Claim;
use klyra_service::builder::{build_crate, get_config, Runtime};
...
/// an embedded runtime for legacy, and a .wasm file for klyra-next.
...
mod tests {
    ...
    use klyra_service::builder::Runtime;
