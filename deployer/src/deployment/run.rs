...
mod tests {
    ...
    use async_trait::async_trait;
    use portpicker::pick_unused_port;
    use klyra_common::{claims::Claim, storage_manager::ArtifactsStorageManager};
    use klyra_common_tests::logger::mocked_logger_client;
    use klyra_proto::{
        logger::{
    ...
    impl ResourceManager for StubResourceManager {
        ...
        async fn insert_resources(
            &mut self,
            _resources: Vec<klyra_proto::resource_recorder::record_request::Resource>,
