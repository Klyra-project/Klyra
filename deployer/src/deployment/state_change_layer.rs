...
mod tests {
    ...
    use klyra_common_tests::{builder::mocked_builder_client, logger::mocked_logger_client};
    use klyra_proto::{
    ...
    static RECORDER: RecorderMock = {
        ...
        let filter_layer = EnvFilter::try_from_default_env()
            .or_else(|_| EnvFilter::try_new("klyra_deployer"))
            .unwrap();
    ...
    impl BuildQueueClient for StubBuildQueueClient {
        async fn get_slot(
            &self,
            _id: Uuid,
        ) -> Result<bool, klyra_common::backends::client::Error> {
            Ok(true)
        }
        ...
        async fn release_slot(
            &self,
            _id: Uuid,
        ) -> Result<(), klyra_common::backends::client::Error> {
            Ok(())
        }
    }
    ...
    impl ResourceManager for StubResourceManager {
        ...
        async fn insert_resources(
            &mut self,
            _resource: Vec<klyra_proto::resource_recorder::record_request::Resource>,
        ...
        async fn get_resource(
            &mut self,
            _service_id: &ulid::Ulid,
            _type: klyra_common::resource::Type,
            _claim: Claim,
