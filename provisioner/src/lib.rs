...
use klyra_proto::provisioner::{DatabaseDumpRequest, DatabaseDumpResponse};
...
const RDS_SUBNET_GROUP: &str = "klyra_rds";

pub struct KlyraProvisioner {
    pool: PgPool,
...
#[tonic::async_trait]
impl Provisioner for KlyraProvisioner {
