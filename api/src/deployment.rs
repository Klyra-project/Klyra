use crate::{build::Build, BuildSystem, KlyraFactory};
use anyhow::{anyhow, Context as AnyhowContext};
use core::default::Default;
use klyra_common::project::ProjectConfig;
use klyra_common::{DeploymentApiError, DeploymentId, DeploymentMeta, DeploymentStateMeta, Host, Port};
            ...
            *state = match state.take() {
                ...
                DeploymentState::Loaded(mut loaded) => {
                    ...
                    match db_state.ensure().await {
                        ...
                        Ok(()) => {
                            let mut factory = KlyraFactory::new(&mut db_state);
...
type ServeHandle = JoinHandle<Result<(), klyra_service::Error>>;
...
enum DeploymentState {
    ...
    /// implementation of the [`klyra_service::Service`] trait.
    Loaded(LoadedState),
