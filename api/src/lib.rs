...
async fn version() -> String {
    String::from(klyra_service::VERSION)
}
...
pub async fn rocket() -> Rocket<Build> {
    env_logger::Builder::new()
        ...
        .filter_module("klyra_api", log::LevelFilter::Debug)
        .filter_module("klyra_service", log::LevelFilter::Debug)
        .init();
