...
#[schema(as = klyra_common::log::Item)]
pub struct Item {
    #[schema(value_type = KnownFormat::Uuid)]
    pub id: Uuid,
    #[schema(value_type = KnownFormat::DateTime)]
    pub timestamp: DateTime<Utc>,
    #[schema(value_type = klyra_common::deployment::State)]
    pub state: State,
    #[schema(value_type = klyra_common::log::Level)]
    pub level: Level,
...
#[schema(as = klyra_common::log::Level)]
pub enum Level {
    Trace,
    Debug,
    Info,
