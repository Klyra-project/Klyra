...
#[cfg_attr(feature = "openapi", schema(as = klyra_common::log::Item))]
pub struct Item {
    ...
    #[cfg_attr(feature = "openapi", schema(value_type = klyra_common::deployment::State))]
    pub state: State,
    #[cfg_attr(feature = "openapi", schema(value_type = klyra_common::log::Level))]
    pub level: Level,
...
#[cfg_attr(feature = "openapi", derive(ToSchema))]
#[cfg_attr(feature = "openapi", schema(as = klyra_common::log::Level))]
pub enum Level {
    Trace,
    Debug,
    Info,
