...
#[cfg_attr(feature = "openapi", schema(as = klyra_common::models::deployment::Response))]
pub struct Response {
...
#[cfg_attr(feature = "openapi", derive(ToSchema))]
#[cfg_attr(feature = "openapi", schema(as = klyra_common::models::deployment::DeploymentRequest))]
