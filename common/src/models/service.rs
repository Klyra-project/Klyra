...
#[cfg_attr(feature = "openapi", schema(as = klyra_common::models::service::Response))]
pub struct Response {
...
#[derive(Deserialize, Serialize)]
#[cfg_attr(feature = "openapi", derive(ToSchema))]
#[cfg_attr(feature = "openapi", schema(as = klyra_common::models::service::Summary))]
pub struct Summary {
    pub name: String,
    #[cfg_attr(feature = "openapi", schema(value_type = klyra_common::models::deployment::Response))]
