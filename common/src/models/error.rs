    ...
    fn from(kind: ErrorKind) -> Self {
        let (status, error_message) = match kind {
            ...
            ErrorKind::ProjectNotFound => (
                ...
                "project not found. Run `cargo klyra project start` to create a new project.",
            ),
            ...
            ErrorKind::ProjectAlreadyRunning => (
                StatusCode::BAD_REQUEST,
                "it looks like your project is already running. You can find out more with `cargo klyra project status`",
            ),
