...
pub enum ErrorKind {
    ...
    UserAlreadyExists,
    #[error("Project '{0}' not found. Make sure you are the owner of this project name. Run `cargo klyra project start` to create a new project.")]
    ...
    #[error("Project not ready. Try running `cargo klyra project restart`.")]
    ProjectNotReady,
    #[error("Project returned invalid response")]
    ProjectUnavailable,
    #[error("You cannot create more projects. Delete some projects first.")]
    TooManyProjects,
    #[error("Could not automatically delete the following resources: {0:?}. Please reach out to Klyra support for help.")]
    ProjectHasResources(Vec<String>),
    #[error("Could not automatically stop the running deployment for the project. Please reach out to Klyra support for help.")]
    ProjectHasRunningDeployment,
    #[error("Project currently has a deployment that is busy building. Use `cargo klyra deployment list` to see it and wait for it to finish")]
    ProjectHasBuildingDeployment,
    #[error("Tried to get project into a ready state for deletion but failed. Please reach out to Klyra support for help.")]
    ProjectCorrupted,
