...
#[cfg_attr(feature = "openapi", schema(as = klyra_common::models::project::Response))]
pub struct Response {
    #[cfg_attr(feature = "openapi", schema(schema_with = ulid_type))]
    pub id: String,
    pub name: String,
    #[cfg_attr(feature = "openapi", schema(value_type = klyra_common::models::project::State))]
    pub state: State,
...
#[cfg_attr(feature = "openapi", derive(ToSchema))]
#[cfg_attr(feature = "openapi", schema(as = klyra_common::models::project::State))]
pub enum State {
...
#[derive(Deserialize, Serialize)]
#[cfg_attr(feature = "openapi", derive(ToSchema))]
#[cfg_attr(feature = "openapi", schema(as = klyra_common::models::project::AdminResponse))]
    ...
    pub fn is_valid(name: &str) -> bool {
        ...
        fn is_reserved(name: &str) -> bool {
            ...
            INSTANCE.get_or_init(|| {
                HashSet::from(["klyraapp", "klyra", "console", "unstable", "staging"])
            });
