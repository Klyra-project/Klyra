...
#[schema(as = klyra_common::models::project::Response)]
pub struct Response {
    pub name: String,
    #[schema(value_type = klyra_common::models::project::State)]
    pub state: State,
}

#[derive(Clone, Debug, Deserialize, Serialize, EnumString, ToSchema)]
#[serde(rename_all = "lowercase")]
#[schema(as = klyra_common::models::project::State)]
pub enum State {
...
#[schema(as = klyra_common::models::project::AdminResponse)]
