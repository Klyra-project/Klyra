...
/// The input given to Klyra DB resources
...
/// The output produced by Klyra DB resources
...
///
/// Use [`Self::connection_string_klyra`] when running on Klyra,
...
impl DatabaseInfo {
    ...
    /// For connecting to the db from inside the Klyra network
    pub fn connection_string_klyra(&self) -> String {
        format!(
            "{}://{}:{}@{}:{}/{}",
            self.engine,
            self.role_name,
...
pub struct DatabaseInfoBeta {
    ...
    database_name: String,
    port: String,
    #[serde(alias = "hostname_klyra")] // compatibility to parse from a `DatabaseInfo`
    hostname: String,
...
pub struct VersionInfo {
    ...
    /// Latest version of cargo-klyra compatible with this gateway.
    pub cargo_klyra: semver::Version,
    /// Latest version of klyra-deployer compatible with this gateway.
    pub deployer: semver::Version,
    /// Latest version of klyra-runtime compatible with the above deployer.
