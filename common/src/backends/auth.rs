...
use super::{
    ...
    headers::XKlyraAdminSecret,
};

pub const EXP_MINUTES: i64 = 5;
const ISS: &str = "klyra";
const PUBLIC_KEY_CACHE_KEY: &str = "klyra.public-key";
    ...
    S::Future: Send + 'static,
{
    ...
    fn call(&mut self, req: Request<Body>) -> Self::Future {
        let error = match req.headers().typed_try_get::<XKlyraAdminSecret>() {
...
/// The scope of operations that can be performed on klyra
