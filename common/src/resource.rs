...
#[cfg_attr(feature = "openapi", schema(as = klyra_common::resource::Response))]
pub struct Response {
    /// The type of this resource.
    #[cfg_attr(feature = "openapi", schema(value_type = klyra_common::resource::Type))]
    pub r#type: Type,
...
#[cfg_attr(feature = "openapi", derive(ToSchema))]
#[cfg_attr(feature = "openapi", schema(as = klyra_common::resource::Type))]
pub enum Type {
    #[cfg_attr(feature = "openapi", schema(value_type = klyra_common::database::Type))]
