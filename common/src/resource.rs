...
#[schema(as = klyra_common::resource::Response)]
pub struct Response {
    /// The type of this resource.
    #[schema(value_type = klyra_common::resource::Type)]
    pub r#type: Type,
...
#[schema(as = klyra_common::resource::Type)]
pub enum Type {
    #[schema(value_type = klyra_common::database::Type)]
