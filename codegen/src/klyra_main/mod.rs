    ...
    quote! {
        fn main() {
            ...
            ::klyra_runtime::tokio::runtime::Builder::new_multi_thread()
                ...
                .unwrap()
                .block_on(async {
                    ::klyra_runtime::__internals::start(loader).await;
                })
        }
...
impl ToTokens for Loader {
    fn to_tokens(&self, tokens: &mut proc_macro2::TokenStream) {
        ...
        let (factory_ident, resource_tracker_ident, extra_imports): (Ident, Ident, Option<Stmt>) =
            if self.fn_inputs.is_empty() {
                ...
                (
                    ...
                    Some(parse_quote!(
                        use ::klyra_runtime::{Factory, IntoResource};
                    )),
                )
            };
        ...
        let loader = quote! {
            async fn loader(
                mut #factory_ident: ::klyra_runtime::__internals::ProvisionerFactory,
                mut #resource_tracker_ident: ::klyra_runtime::__internals::ResourceTracker,
            ) -> #return_type {
                ...
                #(
                    let #fn_inputs: #fn_inputs_types =
                        ::klyra_runtime::__internals::get_resource::<_, _, #fn_inputs_types>(
...
mod tests {
    ...
    fn output_with_return() {
        ...
        let expected = quote! {
            async fn loader(
                mut _factory: ::klyra_runtime::__internals::ProvisionerFactory,
                mut _resource_tracker: ::klyra_runtime::__internals::ResourceTracker,
            ) -> KlyraSimple {
                use ::klyra_runtime::__internals::Context;
                simple().await
            }
    ...
    fn output_with_inputs() {
        ...
        let expected = quote! {
            async fn loader(
                mut factory: ::klyra_runtime::__internals::ProvisionerFactory,
                mut resource_tracker: ::klyra_runtime::__internals::ResourceTracker,
            ) -> KlyraComplex {
                use ::klyra_runtime::__internals::Context;
                use ::klyra_runtime::{Factory, IntoResource};
                let pool: sqlx::PgPool = ::klyra_runtime::__internals::get_resource::<_, _, sqlx::PgPool>(
                    klyra_shared_db::Postgres::default(),
                    &mut factory,
                    &mut resource_tracker,
                )
                .await
                .context(format!("failed to provision {}", stringify!(klyra_shared_db::Postgres)))?
                .into_resource()
                .await
                .context(format!("failed to initialize {}", stringify!(klyra_shared_db::Postgres)))?;
                let redis: something::Redis = ::klyra_runtime::__internals::get_resource::<_, _, something::Redis>(
                    klyra_shared_db::Redis::default(),
                    &mut factory,
                    &mut resource_tracker,
                )
                .await
                .context(format!("failed to provision {}", stringify!(klyra_shared_db::Redis)))?
                .into_resource()
                .await
    ...
    fn output_with_input_options() {
        ...
        let expected = quote! {
            async fn loader(
                ...
                let pool: sqlx::PgPool = ::klyra_runtime::__internals::get_resource::<_, _, sqlx::PgPool>(
                    klyra_shared_db::Postgres::default().size(&::klyra_runtime::__internals::strfmt("10Gb", &__vars)?).public(false),
                    &mut factory,
                    &mut resource_tracker,
                )
                .await
