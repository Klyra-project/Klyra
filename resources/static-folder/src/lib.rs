...
use serde::Serialize;
use klyra_service::{Error, Factory, ResourceBuilder, Type};

#[derive(Serialize)]
#[deprecated(
    since = "0.27.0",
    note = "Folder names can now be hard coded. More about deployment files: https://docs.klyra.rs/configuration/files"
)]
