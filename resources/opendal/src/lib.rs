...
impl IntoResource<Operator> for OpendalOutput {
    async fn into_resource(self) -> Result<Operator, klyra_service::Error> {
...
mod test {
    use super::*;
    use klyra_service::{Environment, Secret};
    ...
    impl Factory for MockFactory {
        ...
        async fn get_secrets(
            &mut self,
        ) -> Result<BTreeMap<String, Secret<String>>, klyra_service::Error> {
            let secrets = self
                .secrets
                .iter()
