...
#[command(
    ...
    arg(clap::Arg::new("dummy")
        .value_parser([PossibleValue::new("klyra")])
        .required(false)
        .hide(true))
)]
pub struct KlyraArgs {
    ...
    pub offline: bool,
    /// Turn on tracing output for Klyra libraries. (WARNING: can print sensitive data)
    #[arg(global = true, long, env = "klyra_DEBUG")]
    pub debug: bool,
...
pub enum Command {
    ...
    Status,
    /// Stop a Klyra service
    Stop,
    /// View build and deployment logs
    Logs(LogsArgs),
    /// Manage Klyra projects
    ...
    Clean,
    /// Show info about your Klyra account
    #[command(visible_alias = "acc")]
    Account,
    /// Log in to the Klyra platform
    Login(LoginArgs),
    ...
    Feedback,
    /// Upgrade the cargo-klyra binary
    Upgrade {
...
pub enum ProjectCommand {
    ...
    /// Link this workspace to a Klyra project
    Link,
}
...
pub struct DeployArgs {
    ...
    pub image: Option<String>, // TODO?: Make this a subcommand instead? `klyra deploy image ...`
...
pub struct InitArgs {
    ...
    #[arg(long)]
    pub force_name: bool,
    /// Whether to start the container for this project on Klyra, and claim the project name
    #[arg(long)]
    pub create_env: bool,
...
mod tests {
    ...
    #[test]
    fn test_klyra_args() {
        KlyraArgs::command().debug_assert();
    }
