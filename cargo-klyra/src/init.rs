...
impl Framework {
    ...
    pub fn init_config(&self) -> Box<dyn KlyraInit> {
        match self {
            ...
            Framework::Axum => Box::new(KlyraInitAxum),
            Framework::Rocket => Box::new(KlyraInitRocket),
            Framework::Tide => Box::new(KlyraInitTide),
            Framework::Tower => Box::new(KlyraInitTower),
            Framework::Poem => Box::new(KlyraInitPoem),
            Framework::Salvo => Box::new(KlyraInitSalvo),
            Framework::Serenity => Box::new(KlyraInitSerenity),
            Framework::Poise => Box::new(KlyraInitPoise),
            Framework::Warp => Box::new(KlyraInitWarp),
            Framework::Thruster => Box::new(KlyraInitThruster),
            Framework::None => Box::new(KlyraInitNoOp),
        }
    }
}
...
mod klyra_init_tests {
    ...
    fn test_set_cargo_dependencies_axum() {
        ...
        KlyraInitAxum.set_cargo_dependencies(
            dependencies,
            &manifest_path,
            &url,
            mock_get_latest_dependency_version,
    ...
    fn test_set_cargo_dependencies_tide() {
        ...
        KlyraInitTide.set_cargo_dependencies(
            dependencies,
            &manifest_path,
            &url,
            mock_get_latest_dependency_version,
    ...
    fn test_set_cargo_dependencies_tower() {
        ...
        KlyraInitTower.set_cargo_dependencies(
            dependencies,
            &manifest_path,
            &url,
            mock_get_latest_dependency_version,
    ...
    fn test_set_cargo_dependencies_serenity() {
        ...
        KlyraInitSerenity.set_cargo_dependencies(
            dependencies,
            &manifest_path,
            &url,
            mock_get_latest_dependency_version,
    ...
    fn test_set_cargo_dependencies_poise() {
        ...
        KlyraInitPoise.set_cargo_dependencies(
            dependencies,
            &manifest_path,
            &url,
            mock_get_latest_dependency_version,
    ...
    fn test_set_cargo_dependencies_thruster() {
        ...
        KlyraInitThruster.set_cargo_dependencies(
            dependencies,
            &manifest_path,
            &url,
            mock_get_latest_dependency_version,
