...
impl Klyra {
    ...
    async fn init(
        ...
        let should_create_environment = if !interactive {
            ...
            let should_create = Confirm::with_theme(&theme)
                .with_prompt("Do you want to create the project environment on Klyra?")
                .default(true)
                .interact()?;
            println!();
            should_create
        ...
        if !should_create_environment {
            ...
            if serenity_idle_hint {
                printdoc!(
                    ...
                    project so that they don't go offline: https://docs.klyra.rs/getting-started/idle-projects
                    "
                );
            }
        }
    ...
    async fn project_create(&self, idle_minutes: u64) -> Result<CommandOutcome> {
        ...
        if idle_minutes > 0 {
            ...
            println!("To change the idle time refer to the docs: https://docs.klyra.rs/getting-started/idle-projects");
            println!();
        }
