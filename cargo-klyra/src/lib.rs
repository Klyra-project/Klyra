...
use klyra_common::models::resource::get_certificates_table_beta;
use klyra_common::{
    constants::{
...
impl Klyra {
    ...
    pub async fn run(
        ...
        if self.beta {
            ...
            eprintln!("This command is not supported on the legacy platform. Set --beta or klyra_BETA=true.");
            return Ok(CommandOutcome::Ok);
        }
...
mod tests {
    ...
    fn get_archive_entries(
        ...
        let mut klyra = Klyra::new().unwrap();
