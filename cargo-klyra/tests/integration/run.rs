...
async fn cargo_klyra_run(working_directory: &str) -> u16 {
...
async fn rocket_hello_world() {
    let port = cargo_klyra_run("../examples/rocket/hello-world").await;
...
async fn rocket_secrets() {
    let port = cargo_klyra_run("../examples/rocket/secrets").await;
...
async fn rocket_postgres() {
    let port = cargo_klyra_run("../examples/rocket/postgres").await;
...
async fn rocket_authentication() {
    let port = cargo_klyra_run("../examples/rocket/authentication").await;
    let client = reqwest::Client::new();
...
// TODO: remove ignore when updated examples are merged: https://github.com/klyra-hq/examples/pull/4
#[ignore]
#[tokio::test(flavor = "multi_thread")]
async fn actix_web_hello_world() {
    let port = cargo_klyra_run("../examples/actix-web/hello-world").await;
...
async fn axum_hello_world() {
    let port = cargo_klyra_run("../examples/axum/hello-world").await;
...
async fn tide_hello_world() {
    let port = cargo_klyra_run("../examples/tide/hello-world").await;
...
async fn tower_hello_world() {
    let port = cargo_klyra_run("../examples/tower/hello-world").await;
...
async fn warp_hello_world() {
    let port = cargo_klyra_run("../examples/warp/hello-world").await;
...
async fn poem_hello_world() {
    let port = cargo_klyra_run("../examples/poem/hello-world").await;
...
async fn poem_postgres() {
    let port = cargo_klyra_run("../examples/poem/postgres").await;
    let client = reqwest::Client::new();
...
async fn poem_mongodb() {
    let port = cargo_klyra_run("../examples/poem/mongodb").await;
    let client = reqwest::Client::new();
...
async fn salvo_hello_world() {
    let port = cargo_klyra_run("../examples/salvo/hello-world").await;
...
async fn thruster_hello_world() {
    let port = cargo_klyra_run("../examples/thruster/hello-world").await;
