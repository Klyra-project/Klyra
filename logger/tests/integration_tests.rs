...
use klyra_logger::{Service, KlyraLogsOtlp, Sqlite};
...
async fn generate_and_get_runtime_logs() {
    ...
    tokio::task::spawn(async move {
        ...
        Server::builder()
            ...
            .add_service(TraceServiceServer::new(KlyraLogsOtlp::new(
                sqlite.get_sender(),
            )))
...
/// For the klyra-runtime logs we want to add the deployment id to the top level attributes,
