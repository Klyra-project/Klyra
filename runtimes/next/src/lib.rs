...
use klyra_runtime_proto::runtime::runtime_server::Runtime;
use klyra_runtime_proto::runtime::{LoadRequest, LoadResponse, StartRequest, StartResponse};
...
impl BotInner {
    pub async fn message(&mut self, new_message: &str) -> Option<String> {
        ...
        self.linker
            .get(&mut self.store, "bot", "__klyra_EventHandler_message")
            .unwrap()
            .into_func()
            .unwrap()
