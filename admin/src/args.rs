...
use klyra_common::{constants::API_URL_PRODUCTION, models::user::UserId};

#[derive(Parser, Debug)]
pub struct Args {
    /// run this command against the api at the supplied url
    #[arg(long, default_value = API_URL_PRODUCTION, env = "klyra_API")]
    pub api_url: String,
...
pub enum AcmeCommand {
    ...
    /// Renew the certificate for the klyra gateway.
