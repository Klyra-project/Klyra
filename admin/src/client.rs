...
use klyra_common::models::project::{ComputeTier, ProjectResponseBeta, ProjectUpdateRequestBeta};

pub struct Client {
    pub inner: KlyraApiClient,
}

impl Client {
    pub fn new(api_url: String, api_key: String, timeout: u64) -> Self {
        Self {
            inner: KlyraApiClient::new(api_url, Some(api_key), None, Some(timeout)),
        }
    }
