...
pub mod runtime {
    ...
    impl TryFrom<LogItem> for klyra_common::LogItem {
    ...
    impl From<LogLevel> for klyra_common::log::Level {
    ...
    impl From<klyra_common::wasm::Log> for LogItem {
        fn from(log: klyra_common::wasm::Log) -> Self {
    ...
    impl From<klyra_common::wasm::Level> for LogLevel {
        fn from(level: klyra_common::wasm::Level) -> Self {
            match level {
                klyra_common::wasm::Level::Trace => Self::Trace,
                klyra_common::wasm::Level::Debug => Self::Debug,
                klyra_common::wasm::Level::Info => Self::Info,
                klyra_common::wasm::Level::Warn => Self::Warn,
                klyra_common::wasm::Level::Error => Self::Error,
            }
        }
    }
...
pub mod resource_recorder {
    ...
    impl TryFrom<record_request::Resource> for klyra_common::resource::Response {
        type Error = anyhow::Error;

        fn try_from(resource: record_request::Resource) -> Result<Self, Self::Error> {
            let r#type = klyra_common::resource::Type::from_str(resource.r#type.as_str())
                .map_err(anyhow::Error::msg)
                .context("resource type should have a valid resource string")?;
            let response = klyra_common::resource::Response {
                r#type,
    ...
    impl TryFrom<Resource> for klyra_common::resource::Response {
        type Error = anyhow::Error;
