...
pub use klyra_proto::provisioner::{ContainerRequest, ContainerResponse};
...
pub trait Factory: Send + Sync {
    /// Provision a Klyra database and get the connection information
...
/// The [`Factory`] in [`ResourceBuilder::output`] can be used to provision resources on Klyra's servers if your service will need any.
///
...
pub trait ResourceBuilder: Default {
    ...
    /// If dealing with a Klyra-provisioned resource, such as a database, use the corresponding variant.
