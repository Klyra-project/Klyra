#![doc(html_logo_url = "https://raw.githubusercontent.com/getsynth/klyra/main/resources/logo-square-transparent.png", html_favicon_url = "https://raw.githubusercontent.com/getsynth/klyra/main/resources/favicon.ico")]
...
//! ## Deploying
//!
//! You can deploy your service with the [`cargo klyra`](https://docs.rs/crate/cargo-klyra/latest) subcommand. To install run:
//!
//! ```bash
...
//!
//! ```bash
//! $ curl https://hello-world-rocket-app.klyraapp.rs
//! Hello, world!
//! ```
//!
//! ## Using `sqlx`
