...
pub trait ResourceInputBuilder: Default {
    ...
    ///
    /// If the input is a [`klyra_common::models::resource::ProvisionResourceRequest`],
...
pub trait Service: Send {
    ...
    ///
    /// The passed [`SocketAddr`] receives proxied HTTP traffic from your Klyra subdomain (or custom domain).
