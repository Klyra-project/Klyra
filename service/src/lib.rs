...
pub use klyra_common::project::ProjectName as ServiceName;
...
// See https://github.com/klyra-hq/klyra/pull/348
#[allow(dead_code)]
...
#[cfg(feature = "web-poem")]
pub type KlyraPoem<T> = Result<T, Error>;
...
#[cfg(feature = "web-warp")]
pub type KlyraWarp<T> = Result<warp::filters::BoxedFilter<T>, Error>;
...
#[cfg(feature = "web-axum")]
pub type KlyraAxum = Result<axum::Router, Error>;
...
#[cfg(feature = "web-thruster")]
pub type KlyraThruster<T> = Result<T, Error>;
...
#[cfg(feature = "bot-serenity")]
pub type KlyraSerenity = Result<serenity::Client, Error>;
...
#[cfg(feature = "bot-poise")]
pub type KlyraPoise<T, E> = Result<std::sync::Arc<poise::Framework<T, E>>, Error>;
